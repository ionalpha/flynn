...
// is its isolation.
//
// As with the microVM tier, the critical part is pure: buildContainerArgv composes
...
// the security-critical invariants are testable in isolation, exactly as the microVM
