...
func Default() *Theme {
	return &Theme{name: "default", styles: map[Role]Style{
		...
		SyntaxKeyword:   {Foreground: "magenta"},
		SyntaxString:    {Foreground: "green"},
		SyntaxNumber:    {Foreground: "yellow"},
		SyntaxComment:   {Faint: true, Italic: true},
		SyntaxFunction:  {Foreground: "cyan"},
		SyntaxType:      {Foreground: "blue"},
...
func HighContrast() *Theme {
	return &Theme{name: "high-contrast", styles: map[Role]Style{
		...
		Strong:          {Bold: true},
		Heading:         {Bold: true, Underline: true},
		SyntaxKeyword:   {Foreground: "bright-magenta", Bold: true},
		SyntaxString:    {Foreground: "bright-green"},
		SyntaxNumber:    {Foreground: "bright-yellow"},
		SyntaxComment:   {Italic: true},
		SyntaxFunction:  {Foreground: "bright-cyan", Bold: true},
		SyntaxType:      {Foreground: "bright-blue", Bold: true},
