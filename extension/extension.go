...
// conforms to. An Extension is a typed resource on the event-sourced substrate
...
// the substrate stores and a handler interprets. The spec is the default and
...
type Spec struct {
	...
	// provenance. It is distinct from the resource revision the substrate assigns: one
	...
	// spec stays pure data the substrate can admit, version, and sync. This is the
