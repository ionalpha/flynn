...
// duplication.
//
// The split of roles is deliberate and mirrors the foundation: the spine is the
...
// what subscribers eventually read and a missed wake self-heals on the next one.
